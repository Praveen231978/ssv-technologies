...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: 'Surya Vedangi is the founder and CEO of SSV Technologies Pvt. Ltd., bringing over a decade of experience in IT staffing, digital transformation, and enterprise technology consulting. With a deep understanding of both the US and Indian technology markets, Surya has built SSV Technologies into a trusted partner for companies and candidates across the globe. His vision of combining human expertise with Agentic AI drives the company\'s innovative approach to digital marketing and talent placement.',
    linkedinUrl: 'https://www.linkedin.com/in/surya-vedangi',
  },
  {
    id: 'operations-lead',
    name: 'Ambika V.',
